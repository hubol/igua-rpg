...
export let BiguaHorn: PIXI.Texture;
...
export let CapitalBrickWall: PIXI.Texture;
...
export let CapitalDitherEdge: PIXI.Texture;
export let CapitalFireplaceFlame: PIXI.Texture;
export let CapitalFireplace: PIXI.Texture;
export let CapitalImpossiblePuzzle: PIXI.Texture;
...
export let CharacterHead: PIXI.Texture;
...
export let ClownWonderfulGhost: PIXI.Texture;
...
export let ColorfulBricks: PIXI.Texture;
...
export let FinalEmoWizardFace: PIXI.Texture;
export let FinalEnemySoul: PIXI.Texture;
...
export let FinalStalactite: PIXI.Texture;
...
export let GiantsUpblock: PIXI.Texture;
...
export let NpcBlueFoot: PIXI.Texture;
export let NpcCurvedCrest2: PIXI.Texture;
export let NpcCurvedCrest: PIXI.Texture;
export let NpcGreenPolkaBody: PIXI.Texture;
export let NpcHornedCrest: PIXI.Texture;
export let NpcLongTailBody: PIXI.Texture;
...
export let OrnateClownSpikeBall: PIXI.Texture;
...
export let VileClownArmSide: PIXI.Texture;
...
export function loadTexturesAsync()
{
    ...
    const BiguaHornPath = require("./images/bigua/horn.png");
    loader.add(BiguaHornPath); 
    ...
    const CapitalBrickWallPath = require("./images/capital/brick wall.png");
    loader.add(CapitalBrickWallPath); 

    const CapitalBricksPath = require("./images/capital/bricks.png");
    loader.add(CapitalBricksPath); 

    const CapitalBubblePath = require("./images/capital/bubble.png");
    loader.add(CapitalBubblePath); 

    const CapitalBuilding1Path = require("./images/capital/building1.png");
    loader.add(CapitalBuilding1Path); 
    ...
    const CapitalDitherEdgePath = require("./images/capital/dither edge.png");
    loader.add(CapitalDitherEdgePath); 
    ...
    const CapitalImpossiblePuzzlePath = require("./images/capital/impossible puzzle.png");
    loader.add(CapitalImpossiblePuzzlePath); 
    ...
    const ClownWonderfulGhostPath = require("./images/clown wonderful ghost.png");
    loader.add(ClownWonderfulGhostPath); 
    ...
    const ColorfulBricksPath = require("./images/colorful bricks.png");
    loader.add(ColorfulBricksPath); 
    ...
    const CrackSmallPath = require("./images/crack small.png");
    loader.add(CrackSmallPath); 
    ...
    const FinalEmoCouchPath = require("./images/final/emo couch.png");
    loader.add(FinalEmoCouchPath); 

    const FinalEmoTrinketsPath = require("./images/final/emo trinkets.png");
    loader.add(FinalEmoTrinketsPath); 
    ...
    const FinalEmoWizardDressFringePath = require("./images/final/emo wizard dress fringe.png");
    loader.add(FinalEmoWizardDressFringePath); 

    const FinalEmoWizardDressPath = require("./images/final/emo wizard dress.png");
    loader.add(FinalEmoWizardDressPath); 

    const FinalEmoWizardFacePath = require("./images/final/emo wizard face.png");
    loader.add(FinalEmoWizardFacePath); 

    const FinalEnemySoulPath = require("./images/final/enemy soul.png");
    loader.add(FinalEnemySoulPath); 
    ...
    const FinalStalactitePath = require("./images/final/stalactite.png");
    loader.add(FinalStalactitePath); 
    ...
    const GiantsSlotMachineSymbolsPath = require("./images/giants/slot machine symbols.png");
    loader.add(GiantsSlotMachineSymbolsPath); 

    const GiantsSlotMachinePath = require("./images/giants/slot machine.png");
    loader.add(GiantsSlotMachinePath); 

    const GiantsUpblockPath = require("./images/giants/upblock.png");
    loader.add(GiantsUpblockPath); 
    ...
    const HintArrowPath = require("./images/hint arrow.png");
    loader.add(HintArrowPath); 
    ...
    const JungleHiddenHouseWallsPath = require("./images/jungle/hidden house walls.png");
    loader.add(JungleHiddenHouseWallsPath); 
    ...
    const JunglePlankEndPath = require("./images/jungle/plank end.png");
    loader.add(JunglePlankEndPath); 
    ...
    const JungleTentPath = require("./images/jungle/tent.png");
    loader.add(JungleTentPath); 
    ...
    const JungleTreeStumpDestructivePath = require("./images/jungle/tree stump destructive.png");
    loader.add(JungleTreeStumpDestructivePath); 

    const JungleTreeStumpPath = require("./images/jungle/tree stump.png");
    loader.add(JungleTreeStumpPath); 
    ...
    const NgBlessingEarthPath = require("./images/ng/blessing earth.png");
    loader.add(NgBlessingEarthPath); 
    ...
    const OrnateClownSpikeBallPath = require("./images/ornate clown/spike ball.png");
    loader.add(OrnateClownSpikeBallPath); 
    ...
    const PlayerBallonPopPath = require("./images/player ballon pop.png");
    loader.add(PlayerBallonPopPath); 
    ...
    const PoppingRocksBoxPath = require("./images/popping rocks box.png");
    loader.add(PoppingRocksBoxPath); 
    ...
    const SnowmanFacePath = require("./images/snowman face.png");
    loader.add(SnowmanFacePath); 
    ...
    const SpiderPath = require("./images/spider.png");
    loader.add(SpiderPath); 
    ...
    const VileClownArmSidePath = require("./images/vile clown/arm side.png");
    loader.add(VileClownArmSidePath); 
    ...
    const VolcanoTempleExteriorPath = require("./images/volcano/temple exterior.png");
    loader.add(VolcanoTempleExteriorPath); 
    ...
    return new Promise<void>(resolve =>
    {
        loader.load((_, resources) => {
            ...
            BiguaHorn = resources[BiguaHornPath]?.texture as PIXI.Texture;
            ...
            CapitalBrickWall = resources[CapitalBrickWallPath]?.texture as PIXI.Texture;
            ...
            CapitalDitherEdge = resources[CapitalDitherEdgePath]?.texture as PIXI.Texture;
            ...
            CapitalImpossiblePuzzle = resources[CapitalImpossiblePuzzlePath]?.texture as PIXI.Texture;
            ...
            ClownWonderfulGhost = resources[ClownWonderfulGhostPath]?.texture as PIXI.Texture;
            ...
            ColorfulBricks = resources[ColorfulBricksPath]?.texture as PIXI.Texture;
            ...
            FinalEmoWizardFace = resources[FinalEmoWizardFacePath]?.texture as PIXI.Texture;
            FinalEnemySoul = resources[FinalEnemySoulPath]?.texture as PIXI.Texture;
            ...
            FinalStalactite = resources[FinalStalactitePath]?.texture as PIXI.Texture;
            ...
            GiantsUpblock = resources[GiantsUpblockPath]?.texture as PIXI.Texture;
            ...
            OrnateClownSpikeBall = resources[OrnateClownSpikeBallPath]?.texture as PIXI.Texture;
            ...
            VileClownArmSide = resources[VileClownArmSidePath]?.texture as PIXI.Texture;
