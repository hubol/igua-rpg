...
export const CapitalOutskirtsArgs = {
  ...
  gameObjectsSupplier: () => {
    return {
      CapitalPlantedBush: resolveDecalGameObject({ x: 216, y: 241, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CapitalPlantedBush }),
      CapitalPlantedBush_1: resolveDecalGameObject({ x: 240, y: 241, originX: 0.5, originY: 1, scaleX: -1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CapitalPlantedBush }),
      ...
      Block: resolveBlock({ type: "Block", x: 120, y: 240, width: 400, height: 80, flippedX: false, flippedY: false, uid: "55823268_0", name: "", depth: 0 }),
      Gate: resolveGate({ type: "Gate", x: 488, y: 208, width: 32, height: 32, flippedX: false, flippedY: false, uid: "55920197_1", levelName: "CapitalTown", checkpointName: "FromOutskirts", name: "", depth: 0 }),
      Player: { type: "Player", x: 448, y: 240, flippedX: false, flippedY: false, uid: "55988047_2", faceRight: false, name: "", depth: 0 },
      Door: resolveDoor({ type: "Door", x: 304, y: 208, flippedX: false, flippedY: false, uid: "55913988_3", levelName: "CapitalTemple", checkpointName: "", name: "", depth: 0 }),
      Window2: resolveRegion({ type: "Region", x: 344, y: 172, width: 32, height: 32, flippedX: false, flippedY: false, uid: "25971607_4", name: "Window2", depth: 0 }),
      Window1: resolveRegion({ type: "Region", x: 264, y: 172, width: 32, height: 32, flippedX: false, flippedY: false, uid: "25971607_5", name: "Window1", depth: 0 }),
      FromTemple: { type: "Checkpoint", x: 360, y: 240, flippedX: false, flippedY: false, uid: "55940370_6", name: "FromTemple", faceRight: true, depth: 0 },
      Block_1: resolveBlock({ type: "Block", x: 0, y: 240, width: 120, height: 80, flippedX: false, flippedY: false, uid: "55823268_7", name: "", depth: 0 }),
