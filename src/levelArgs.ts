...
export const CapitalTownArgs = {
  ...
  gameObjectsSupplier: () => {
    return {
      CapitalBuilding1: resolveDecalGameObject({ x: 648, y: 354, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: CapitalBuilding1 }),
      CapitalPlantedTree: resolveDecalGameObject({ x: 768, y: 321, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: CapitalPlantedTree }),
      CapitalPlantedTree_1: resolveDecalGameObject({ x: 536, y: 329, originX: 0.5, originY: 1, scaleX: -1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: CapitalPlantedTree }),
      CapitalPlantedTree_2: resolveDecalGameObject({ x: 368, y: 337, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: CapitalPlantedTree }),
      CapitalInnSign: resolveDecalGameObject({ x: 664, y: 327, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: CapitalInnSign }),
      CapitalPlatform: resolveDecalGameObject({ x: 493.5, y: 329, originX: 0.5, originY: 1, scaleX: 1.033333333333333, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: CapitalPlatform }),
      ShopBuilding: resolveDecalGameObject({ x: 256, y: 320, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: CapitalBuilding1 }),
      CapitalShopSign: resolveDecalGameObject({ x: 241.19148596315182, y: 297.35620476595886, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: CapitalShopSign }),
      CapitalUndergroundBackdrop: resolveDecalGameObject({ x: 216, y: 320, originX: 0, originY: 0, scaleX: 1, scaleY: 1, rotation: 0, layerName: "BackgroundDecals", texture: CapitalUndergroundBackdrop }),
      CloudLong: resolveDecalGameObject({ x: 400, y: 272, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "Parallax1Decals", texture: CloudLong }),
      CloudLong_1: resolveDecalGameObject({ x: 440, y: 288, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "Parallax1Decals", texture: CloudLong }),
      CloudLong_2: resolveDecalGameObject({ x: 600, y: 208, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "Parallax1Decals", texture: CloudLong }),
      CloudLong_3: resolveDecalGameObject({ x: 744, y: 256, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "Parallax1Decals", texture: CloudLong }),
      CloudLong_4: resolveDecalGameObject({ x: 816, y: 280, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "Parallax1Decals", texture: CloudLong }),
