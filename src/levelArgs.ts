...
export const CapitalOutskirtsArgs = {
  ...
  gameObjectsSupplier: () => {
    return {
      CapitalPlantedBush: resolveDecalGameObject({ x: 184, y: 241, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CapitalPlantedBush }),
      CapitalPlantedBush_1: resolveDecalGameObject({ x: 208, y: 241, originX: 0.5, originY: 1, scaleX: -1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CapitalPlantedBush }),
      CapitalPlantedBush_2: resolveDecalGameObject({ x: 232, y: 241, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CapitalPlantedBush }),
      CapitalPlantedTree: resolveDecalGameObject({ x: 376, y: 241, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CapitalPlantedTree }),
      CapitalTemple: resolveDecalGameObject({ x: 288, y: 240, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "BackgroundDecals", texture: CapitalTemple }),
      CloudLong: resolveDecalGameObject({ x: 144, y: 144, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "Parallax1Decals", texture: CloudLong }),
      CloudLong_1: resolveDecalGameObject({ x: 200, y: 168, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "Parallax1Decals", texture: CloudLong }),
      CloudLong_2: resolveDecalGameObject({ x: 400, y: 104, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "Parallax1Decals", texture: CloudLong }),
      Block: resolveBlock({ type: "Block", x: 88, y: 240, width: 400, height: 80, flippedX: false, flippedY: false, uid: "55823268_0", name: "", depth: 0 }),
      Gate: resolveGate({ type: "Gate", x: 456, y: 208, width: 32, height: 32, flippedX: false, flippedY: false, uid: "55920197_1", levelName: "CapitalTown", checkpointName: "FromOutskirts", name: "", depth: 0 }),
      Player: { type: "Player", x: 416, y: 240, flippedX: false, flippedY: false, uid: "55988047_2", faceRight: false, name: "", depth: 0 },
      Door: resolveDoor({ type: "Door", x: 272, y: 208, flippedX: false, flippedY: false, uid: "55913988_3", levelName: "CapitalTemple", checkpointName: "", name: "", depth: 0 }),
      Window2: resolveRegion({ type: "Region", x: 312, y: 172, width: 32, height: 32, flippedX: false, flippedY: false, uid: "25971607_4", name: "Window2", depth: 0 }),
      Window1: resolveRegion({ type: "Region", x: 232, y: 172, width: 32, height: 32, flippedX: false, flippedY: false, uid: "25971607_5", name: "Window1", depth: 0 }),
      FromTemple: { type: "Checkpoint", x: 328, y: 240, flippedX: false, flippedY: false, uid: "55940370_6", name: "FromTemple", faceRight: true, depth: 0 },
      Block_1: resolveBlock({ type: "Block", x: 0, y: 240, width: 88, height: 80, flippedX: false, flippedY: false, uid: "55823268_7", name: "", depth: 0 }),
      Block_2: resolveBlock({ type: "Block", x: 72, y: 144, width: 16, height: 96, flippedX: false, flippedY: false, uid: "55823268_8", name: "", depth: 0 }),
      Block_3: resolveBlock({ type: "Block", x: 0, y: 0, width: 88, height: 144, flippedX: false, flippedY: false, uid: "55823268_9", name: "", depth: 0 }),
      Puzzle: { type: "Anchor", x: 96, y: 216, flippedX: false, flippedY: false, uid: "25979726_10", name: "Puzzle", depth: 0 },
    };
  },
};
...
export const UnrealFireflyArgs = {
  ...
  gameObjectsSupplier: () => {
    return {
      ...
      ValuableOrange: resolveValuableOrange({ type: "ValuableOrange", x: 403, y: 136, flippedX: false, flippedY: false, uid: "56004563_14", name: "", depth: 0 }),
      ValuableOrange_1: resolveValuableOrange({ type: "ValuableOrange", x: 403, y: 120, flippedX: false, flippedY: false, uid: "56004563_15", name: "", depth: 0 }),
      ValuableOrange_2: resolveValuableOrange({ type: "ValuableOrange", x: 403, y: 104, flippedX: false, flippedY: false, uid: "56004563_16", name: "", depth: 0 }),
      ValuableOrange_3: resolveValuableOrange({ type: "ValuableOrange", x: 403, y: 88, flippedX: false, flippedY: false, uid: "56004563_17", name: "", depth: 0 }),
      ValuableOrange_4: resolveValuableOrange({ type: "ValuableOrange", x: 403, y: 72, flippedX: false, flippedY: false, uid: "56004563_18", name: "", depth: 0 }),
      ValuableOrange_5: resolveValuableOrange({ type: "ValuableOrange", x: 403, y: 56, flippedX: false, flippedY: false, uid: "56004563_19", name: "", depth: 0 }),
