...
export const DesertOracleArgs = {
  ...
  gameObjectsSupplier: () => {
    return {
      ...
      PotteryOrangeDamaged: resolveDecalGameObject({ x: 64, y: 482, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: PotteryOrangeDamaged }),
      ...
      PotteryOrangeDamaged_1: resolveDecalGameObject({ x: 104, y: 618, originX: 0.5, originY: 1, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: PotteryOrangeDamaged }),
