...
export const FinalDeepArgs = {
  ...
  gameObjectsSupplier: () => {
    return {
      ...
      FinalStalagSpike: resolveDecalGameObject({ x: 43.55290729603607, y: 94.33951140552688, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: FinalStalagSpike }),
      FinalStalagSpike_1: resolveDecalGameObject({ x: 52.85643950975538, y: 93.05141915983967, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: FinalStalagSpike }),
      FinalStalagSpike_2: resolveDecalGameObject({ x: 71.3340983448036, y: 94.26972633577691, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: FinalStalagSpike }),
      FinalStalagSpike_3: resolveDecalGameObject({ x: 156.2094982684317, y: 93.2544703558292, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: FinalStalagSpike }),
      FinalStalagSpike_4: resolveDecalGameObject({ x: 162.09798295212838, y: 94.16820073778213, originX: 0.5, originY: 0.5, scaleX: 1, scaleY: 1, rotation: 0, layerName: "CloseTerrainDecals", texture: FinalStalagSpike }),
