...
import { resolveSodaStink } from "./gameObjects/sodaStink";
...
export const DesertTownArgs = {
  ...
  gameObjectsSupplier: () => {
    return {
      ...
      Gate_1: resolveGate({ type: "Gate", x: -16, y: 360, width: 32, height: 32, flippedX: false, flippedY: false, uid: "55920197_61", levelName: "OversizedAngelArena", checkpointName: "FromDesert", name: "", depth: 0 }),
...
export const FinalDeepArgs = {
  ...
  gameObjectsSupplier: () => {
    return {
      ...
      CrateWooden: resolveDecalGameObject({ x: 109, y: 170, originX: 0, originY: 0, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CrateWooden }),
      CrateWooden_1: resolveDecalGameObject({ x: 132, y: 194, originX: 0, originY: 0, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CrateWooden }),
      CrateWooden_2: resolveDecalGameObject({ x: 104, y: 194, originX: 0, originY: 0, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CrateWooden }),
      ...
      SodaStink_1: resolveSodaStink({
        ...
        nodes: [
          ...
          { x: 177, y: 99 },
          { x: 152, y: 96 },
          { x: 140.07373023151686, y: 99.68590261135553 },
        ],
        name: "",
        depth: 7,
      }),
...
export const FinalTempleOuterArgs = {
  ...
  gameObjectsSupplier: () => {
    return {
      ...
      CrateWooden: resolveDecalGameObject({ x: 296, y: 178, originX: 0, originY: 0, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CrateWooden }),
      CrateWooden_1: resolveDecalGameObject({ x: 287, y: 154, originX: 0, originY: 0, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CrateWooden }),
      CrateWooden_2: resolveDecalGameObject({ x: 267, y: 178, originX: 0, originY: 0, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CrateWooden }),
      CrateWooden_3: resolveDecalGameObject({ x: 288, y: 202, originX: 0, originY: 0, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CrateWooden }),
      CrateWooden_4: resolveDecalGameObject({ x: 259, y: 202, originX: 0, originY: 0, scaleX: 1, scaleY: 1, rotation: 0, layerName: "TerrainDecals", texture: CrateWooden }),
