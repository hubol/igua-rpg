...
export const CharacterStep2 = new Howl({
    src: [require("./sound/character step 2.ogg"), require("./sound/character step 2.mp3")],
    
});

export const CharacterStep3 = new Howl({
    src: [require("./sound/character step 3.ogg"), require("./sound/character step 3.mp3")],
    
});

export const CharacterStep4 = new Howl({
    src: [require("./sound/character step 4.ogg"), require("./sound/character step 4.mp3")],
    
});

export const CharacterStep = new Howl({
    src: [require("./sound/character step.ogg"), require("./sound/character step.mp3")],
...
export const DassBombLand = new Howl({
    src: [require("./sound/dass bomb land.ogg"), require("./sound/dass bomb land.mp3")],
...
export const DassMoveUp = new Howl({
    src: [require("./sound/dass move up.ogg"), require("./sound/dass move up.mp3")],
...
export const DassPokeLaunch = new Howl({
    src: [require("./sound/dass poke launch.ogg"), require("./sound/dass poke launch.mp3")],
    
});

export const DassPokeReady = new Howl({
    src: [require("./sound/dass poke ready.ogg"), require("./sound/dass poke ready.mp3")],
...
export const SharpSlamReady = new Howl({
    src: [require("./sound/sharp slam ready.ogg"), require("./sound/sharp slam ready.mp3")],
